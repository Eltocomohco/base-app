...
mixin _$NotificationEntity {
 ...
 String get id; String get title; String get body; DateTime get timestamp; String get type;// 'order_status', 'marketing', 'general'
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,timestamp,type,const DeepCollectionEquality().hash(data));

@override
String toString() {
  return 'NotificationEntity(id: $id, title: $title, body: $body, timestamp: $timestamp, type: $type, data: $data)';
}
...
@useResult
$Res call({
 String id, String title, String body, DateTime timestamp, String type, Map<String, dynamic>? data
});
...
/// Create a copy of NotificationEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? body = null,Object? timestamp = null,Object? type = null,Object? data = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String body,  DateTime timestamp,  String type,  Map<String, dynamic>? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.timestamp,_that.type,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String body,  DateTime timestamp,  String type,  Map<String, dynamic>? data)  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity():
return $default(_that.id,_that.title,_that.body,_that.timestamp,_that.type,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String body,  DateTime timestamp,  String type,  Map<String, dynamic>? data)?  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.timestamp,_that.type,_that.data);case _:
  return null;
...
class _NotificationEntity implements NotificationEntity {
  const _NotificationEntity({required this.id, required this.title, required this.body, required this.timestamp, this.type = 'general', final  Map<String, dynamic>? data}): _data = data;
...
// 'order_status', 'marketing', 'general'
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,timestamp,type,const DeepCollectionEquality().hash(_data));
...
/// Create a copy of NotificationEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? body = null,Object? timestamp = null,Object? type = null,Object? data = freezed,}) {
